...
![](https://github.com/DataTalksClub/data-engineering-zoomcamp/raw/main/images/architecture/arch_1.jpg)
...
* [Google BigQuery](https://cloud.google.com/products/bigquery/): serverless data warehouse (central repository of integrated data from one or more disparate sources).
* [Airflow](https://airflow.apache.org/): workflow management platform for data engineering pipelines, also known as a pipeline orchestration tool.
...
![](https://github.com/ziritrion/dataeng-zoomcamp/blob/main/notes/images/01_01.png)
...
Let's create an example pipeline. We will create a dummy `pipeline.py` that receives an argument and prints it.
...
Let's containerize it by creating a Docker image. Create the following `Dockerfile`:
...
![steps](https://github.com/ziritrion/dataeng-zoomcamp/blob/main/notes/images/01_02.png)
...
![steps](https://github.com/ziritrion/dataeng-zoomcamp/blob/main/notes/images/01_03.png)
![steps](https://github.com/ziritrion/dataeng-zoomcamp/blob/main/notes/images/01_04.png)
